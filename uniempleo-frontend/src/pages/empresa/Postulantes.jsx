...
const ESTADO_LABEL = { en_revision:'En Revisión', preseleccionado:'Preseleccionado', aceptado:'Aceptado', rechazado:'Rechazado' }
...
const Postulantes = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Postulantes ({postulantes.length})</h1>
      ...
      {postulantes.length === 0 ? (
        ...
        <div className="space-y-3">
          {postulantes.map(p => (
            <div key={p.id_postulacion} className="card flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
